...
MODEL_PATH = os.path.join(RAW_PATH, "convnext_small_5fold_pretrained_v_flip_mirror_disc_copy_flip_low")
...
LABEL_ID = ['RNFLDS', 'RNFLDI', 'BCLVS', 'BCLVI', 'DH'] #For Low = 2, 3, 4, 5, 7
